...
?>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr bgcolor="#f4fbeb">
            <td width="21%" valign="top"><img src="hinh_anh/LogotypeKvitka.gif" width="200" height="101" align="top" />
            </td>
            ...
            <td colspan="3" valign="top">
                <form name="form1" method="post" action="">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#BBE09D">
                        <tr bgcolor="#F4F8E9">
                            <td colspan="2" align="center" class="style1"><span class="style4"> T&igrave;m ki&#7871;m
                                    b&oacute; hoa </span></td>
                        </tr>
                        <tr>
                            ...
                            <td width="64%" bordercolor="#FFFFFF" bgcolor="#E8F6DC">
                                <input name="ten" type="text" id="ten" size="30" value="<?php echo $tenhoa?>">
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0">
                                ...
                                <tr bgcolor="#F4FBEB">
                                    <td>&nbsp;<a href="timkiem.php" class="style10">T&igrave;m ki&#7871;m b&oacute; hoa
                                        </a></td>
                                </tr>
                                <tr bgcolor="#F4FBEB">
                                    <td>&nbsp;<a href="themhoa.php" class="style10">Th&ecirc;m m&#7899;i b&oacute; hoa
                                        </a></td>
                                </tr>
                            </table>
                        </td>
